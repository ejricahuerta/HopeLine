...
Video.connect(
  ...
  ); //If person randomally disconnects
...
function participantConnected(participant) {
  // When a new person connects to the room that you are in already, get their media.
...
function participantDisconnected(participant) {
  //When someone disconnects, close window
  console.log('Participant "%s" disconnected', participant.identity);
}

function trackSubscribed(div, track) {
  //Attach media to screen
