"use strict";var currentuser="",connection=(new signalR.HubConnectionBuilder).withUrl("http://localhost:5000/chatHub").build();connection.on("ReceiveMessage",function(n,t){var i=currentuser!=n?"bg-success":"bg-secondary",r=t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");$("#chatbox").append('<div id="message"><label>'+n+'<\/label> <div class="'+i+' col-11 mb-1 rounded"> <p class="p-2">'+r+"<\/p><\/div><\/div>")});connection.start().catch(function(n){return console.error(n.toString())});document.getElementById("sendButton").addEventListener("click",function(n){currentuser=document.getElementById("userInput").value;var t=document.getElementById("messageInput").value;document.getElementById("messageInput").value="";connection.invoke("SendMessage",currentuser,t).catch(function(n){return console.error(n.toString())});n.preventDefault()});
/** 
