"use strict";var currentuser="",isConnected=!1,connection=(new signalR.HubConnectionBuilder).withUrl("http://localhost:5000/chatHub").build(),room=document.getElementById("room").value;connection.on("Receivemessage",function(n,t){var i=currentuser!=n?"bg-success":"bg-secondary",r=t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");$("#chatbox").append('<div id="message"><label>'+n+'<\/label> <div class="'+i+' col-11 mb-1 rounded"> <p class="p-2">'+r+"<\/p><\/div><\/div>")});connection.start().catch(function(n){return console.error(n.toString())});document.getElementById("sendButton").addEventListener("click",function(n){currentuser=document.getElementById("userInput").value;var t=document.getElementById("messageInput").value;document.getElementById("messageInput").value="";isConnected||(connection.invoke("AddUserToRoom","room").catch(function(n){return console.error(n.toString())}),isConnected=!0);connection.invoke("SendMessage",currentuser,t,"room").catch(function(n){return console.error(n.toString())});n.preventDefault()});
/** 
