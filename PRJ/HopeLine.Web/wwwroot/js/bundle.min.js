"use strict";var userId=$("#userId")!=null?$("#userId").val():null;if(userId!=null){console.log("User Id = "+userId);var currentuser="",connection,isconnected=!1,room=$("#pin").val();connection=(new signalR.HubConnectionBuilder).withUrl("https://hopelineapi.azurewebsites.net/chatHub").build();connection.on("ReceiveMessage",function(n,t){var i=currentuser==n?"bg-secondary":"bg-info";$("#chatbox").append('<div id="message"><span class= "badge">'+n+'<\/span> <div class="'+i+' col-11 mb-1 rounded"> <p class="p-2">'+t+"<\/p><\/div><\/div>")});connection.on("Load",function(n,t){currentuser=$("#userInput").val();var i=currentuser==n?"bg-secondary":"bg-info";$("#chatbox").append('<div id="message"><span class= "badge">'+n+'<\/span> <div class="'+i+' col-11 mb-1 rounded"> <p class="p-2">'+t+"<\/p><\/div><\/div>")});connection.onclose("ReceiveMessage",function(n,t){var i=currentuser==n?"bg-secondary":"bg-info";$("#chatbox").append('<div id="message"><span class= "badge">'+n+'<\/span> <div class="'+i+' col-11 mb-1 rounded"> <p class="p-2">'+t+"<\/p><\/div><\/div>")});connection.start({withCredentials:!1}).catch(function(n){return console.error(n.toString())});$("#connectButton").click(function(){isconnected||(connection.invoke("AddUserToRoom",room).catch(function(n){return console.error(n.toString())}),isconnected=!0,console.log("Id :"+room),connection.invoke("LoadMessage",room).catch(function(n){return console.error(n.toString())}))});$("#sendButton").click(function(n){currentuser=$("#userInput").val();var t=$("#messageInput").val().trim();console.log("user: "+currentuser);console.log("message: "+t);t&&isconnected&&(connection.invoke("SendMessage",currentuser,t,room).catch(function(n){return console.error(n.toString())}),n.preventDefault(),$("#messageInput").val(" "))})}
/** 
