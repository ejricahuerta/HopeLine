...
namespace HopeLine.API.Controllers
{
    ...
    public class ComResPopulateController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateTopicsAsync()
        {
        ...
        public async Task<IActionResult> CreateCommunitiesAsync()
        {
        ...
        [HttpGet]
        public async Task<IActionResult> CreateResourcesAsync()
        {
